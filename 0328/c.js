...
async function sc()
{
    ...
    let r = await fetch(url);// async means it takes time to load data. await waits for the line to finish before moving to next step
    let rj = await r.json();
    ...
    let sidv = document.querySelector("#sdiv");
